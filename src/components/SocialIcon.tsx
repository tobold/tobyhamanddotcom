    ...
    return (
      <a href="https://github.com/tobold" title="Github">
        <SocialIcon viewBox="0 0 512 512" darkMode={this.props.darkMode}>
          ...
          28.5 19.2 28.5 19.2 16.6 28.4 43.5 20.2 54.1 15.4 1.7-12 6.5-20.2 11.8-24.9 -41.3-4.7-84.7-20.6-84.7-91.9
          0-20.3 7.3-36.9 19.2-49.9 -1.9-4.7-8.3-23.6 1.8-49.2 0 0 15.6-5 51.1 19.1 14.8-4.1 30.7-6.2 46.5-6.3
          15.8 0.1 31.7 2.1 46.6 6.3 35.5-24 51.1-19.1 51.1-19.1 10.1 25.6 3.8 44.5 1.8 49.2 11.9 13 19.1 29.6 19.1
          49.9 0 71.4-43.5 87.1-84.9 91.7 6.7 5.8 12.8 17.1 12.8 34.4 0 24.9 0 44.9 0 51 0 4.9 3 10.7 12.4 8.9 73.8-24.6
      ...
      <a href="http://instgram.com/tobyhamand" title="Instagram">
        <SocialIcon viewBox="0 0 512 512" darkMode={this.props.darkMode}>
          <path
            ...
            -3.2 8.4-7.1 14.3-13.4 20.6 -6.3 6.3-12.2 10.1-20.6 13.4 -6.3 2.5-15.8 5.4-33.2 6.2 -18.9 0.9-24.5 1-72.3
            1s-53.4-0.2-72.3-1c-17.4-0.8-26.9-3.7-33.2-6.2 -8.4-3.2-14.3-7.1-20.6-13.4 -6.3-6.3-10.1-12.2-13.4-20.6
            -2.5-6.3-5.4-15.8-6.2-33.2 -0.9-18.9-1-24.5-1-72.3s0.2-53.4 1-72.3c0.8-17.4 3.7-26.9 6.2-33.2 3.2-8.4
            7.1-14.3 13.4-20.6 6.3-6.3 12.2-10.1 20.6-13.4 6.3-2.5 15.8-5.4 33.2-6.2C202.6 109.5 208.2 109.3 256
            109.3M256 77.1c-48.6 0-54.7 0.2-73.8 1.1 -19 0.9-32.1 3.9-43.4 8.3 -11.8 4.6-21.7 10.7-31.7 20.6 -9.9
            9.9-16.1 19.9-20.6 31.7 -4.4 11.4-7.4 24.4-8.3 43.4 -0.9 19.1-1.1 25.2-1.1 73.8 0 48.6 0.2 54.7 1.1 73.8
            0.9 19 3.9 32.1 8.3 43.4 4.6 11.8 10.7 21.7 20.6 31.7 9.9 9.9 19.9 16.1 31.7 20.6 11.4 4.4 24.4 7.4 43.4
            8.3 19.1 0.9 25.2 1.1 73.8 1.1s54.7-0.2 73.8-1.1c19-0.9 32.1-3.9 43.4-8.3 11.8-4.6 21.7-10.7 31.7-20.6
            9.9-9.9 16.1-19.9 20.6-31.7 4.4-11.4 7.4-24.4 8.3-43.4 0.9-19.1 1.1-25.2
          ...
          />
          <path
            d="M256 164.1c-50.7 0-91.9 41.1-91.9 91.9s41.1 91.9 91.9 91.9 91.9-41.1 91.9-91.9S306.7 164.1 256
            164.1zM256 315.6c-32.9 0-59.6-26.7-59.6-59.6s26.7-59.6 59.6-59.6 59.6 26.7 59.6 59.6S288.9 315.6 256
            315.6z"
          />
      ...
      <a href="https://www.linkedin.com/in/toby-hamand/" title="Linkedin">
        <SocialIcon viewBox="0 0 512 512" darkMode={this.props.darkMode}>
          <path
            ...
            0-98 0-26.3 12.1-41.9 35.2-41.9 21.3 0 31.5 15 31.5 41.9 0 26.9 0 98 0 98h57.5c0 0 0-68.2 0-118.3
      ...
      <a href="https://stackoverflow.com/users/8558260/toby-hamand" title="Stackoverflow">
        <SocialIcon viewBox="0 0 512 512" darkMode={this.props.darkMode}>
          <path
            ...
            31.7L305.8 267.8zM321.2 238l-105-62 -13.2 22.4 105 62L321.2 238zM346.9 219.7l-68.7-100.8 -21.5 14.7 68.7
            100.8L346.9 219.7zM315.5 275.5v106.5H155.6V275.5h-20.8v126.9h201.5V275.5H315.5z"
          />
        </SocialIcon>
      </a>
    );
    ...
    return (
      <a href="https://www.last.fm/user/Tobold" title="Lastfm">
        <SocialIcon viewBox="0 0 512 512" darkMode={this.props.darkMode}>
          ...
          74.402 112.666 74.402 52.727 0 88.437-16.155 88.437-58.672
          0-34.438-19.56-52.297-56.125-60.802l-27.209-5.951c-18.707-4.252-24.233-11.906-24.233-24.659 0-14.456
          11.478-22.96 30.189-22.96 20.406 0 31.458 7.653 33.162
          25.935l42.516-5.103c-3.402-38.263-29.761-53.996-73.127-53.996 -38.266 0-75.68 14.456-75.68 60.799 0 28.912
          14.029 47.197 49.315 55.697l28.916 6.801c21.683 5.104 28.908 14.031 28.908 26.363 0 15.73-15.305 22.107-44.218
          22.107 -42.941 0-60.794-22.534-70.999-53.574l-14.032-42.513c-17.854-55.271-46.342-75.68-102.892-75.68
          -62.499-0.001-95.663 39.538-95.663 106.715 0 64.628 33.164 99.489 92.689 99.489C207.141 359.1 230.104 336.568
          230.104 336.568L230.104 336.568z"
          />
        </SocialIcon>
      </a>
    );
    ...
    return (
      <a href="https://twitter.com/tobyhamand" title="Twitter">
        <SocialIcon viewBox="0 0 512 512" darkMode={this.props.darkMode}>
          ...
          86.9 -10.7-0.3-20.7-3.3-29.5-8.1 -0.7 30.2 20.9 58.4 52.2 64.6 -9.2 2.5-19.2 3.1-29.4 1.1 8.3 25.9 32.3 44.7
           60.8 45.2 -27.4 21.4-61.8 31-96.4 27 28.8 18.5 63 29.2 99.8 29.2 120.8 0 189.1-102.1 185-193.6C399.9 193.1
            410.9 181.7 419.6 168.6z"
          />
        </SocialIcon>
      </a>
    );
    ...
    return (
      <a href="mailto:work@tobyhamand.com" title="Email">
        <SocialIcon viewBox="0 0 512 512" size={32} color="#aaa" hoverColor="black" darkMode={this.props.darkMode}>
          ...
          344.2zM384.4 307.8l-64.4-64.4 64.4-49.3V307.8z"
          />
        </SocialIcon>
      </a>
    );
